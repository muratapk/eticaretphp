...
function openMenuPop(card) {
  alert(card.getAttribute("data-product"));
  ...
  document.getElementById("mpProduct").textContent = productId;
  ...
  document.getElementById("mpAddCart").innerHTML =
    '<i class="fas fa-shopping-cart"></i> Sepette Ekle';
