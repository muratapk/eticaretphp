        ...
        <div class="row align-items-center g-5">
            <div class="col-lg-6" data-aos="fade-right">
                ...
                <div class="cdwrap">
                    ...
                    <div class="cditem"><span class="cdnum" id="cdM">45</span><span class="cdlbl">Minutes</span>
                    </div>
                    <div class="cditem"><span class="cdnum" id="cdS">30</span><span class="cdlbl">Seconds</span>
                    </div>
                </div>
