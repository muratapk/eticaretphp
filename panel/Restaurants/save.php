...
$sql = "insert into restaurants (owner_id,name,description,phone,email,address,city,district,latitude,longitude,minimum_order_amount,delivery_fee,is_open,is_active,created_at) values (?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)";
